<template>
    ...
    <el-drawer id="drawer-dice"
        ...
        <el-row class="row-top" justify="space-evenly">
            <el-button @click="throwDice(4)" type="warning" plain round>D4</el-button>
            <el-button @click="throwDice(6)" type="warning" plain round>D6</el-button>
        </el-row>
        <el-row class="row-top" justify="space-evenly">
            <el-button @click="throwDice(8)" type="warning" plain round>D8</el-button>
            <el-button @click="throwDice(10)" type="warning" plain round>D10</el-button>
        </el-row>
        <el-row class="row-top" justify="space-evenly">
            <el-button @click="throwDice(12)" type="warning" plain round>D12</el-button>
            <el-button @click="throwDice(20)" type="warning" plain round>D20</el-button>
        </el-row>
    </el-drawer>
</template>
...
export default {
    ...
    methods: {
        ...
        // 投掷骰子
        throwDice(n) {
            this.diceNumber = 'D' + n + '：' + (Math.trunc(Math.random() * n) + 1)
        },
    }
}
</script>
